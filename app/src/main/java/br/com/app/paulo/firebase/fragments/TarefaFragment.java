package br.com.app.paulo.firebase.fragments;
...
import br.com.app.paulo.firebase.adapter.RecyclerViewAdapter;
        ...
        btAdd.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (TextUtils.isEmpty(descricao)){
                    Toast.makeText(getContext(),"Informe uma tarefa", Toast.LENGTH_SHORT).show();
                    return;
                }
